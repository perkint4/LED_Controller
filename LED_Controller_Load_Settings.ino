...
int                    test_start_time       = 1220;        // Remeber this is minutes in the day!

void setup() {
  Serial.begin(38400);
  Wire.begin();
  Serial.print("ID is ");
  Serial.print(const_LED_channels);
  Serial.print(" * 100 + ");
  Serial.print(const_version_ID);
  Serial.print(" = ");
  Serial.println(const_LED_channels * 100 + const_version_ID);
  Serial.print("Time slots = ");
  Serial.println(const_time_slots);
